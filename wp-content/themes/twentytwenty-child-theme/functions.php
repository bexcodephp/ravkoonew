...
function my_register_styles() {
	...
	// wp_enqueue_style( 'locomotive', get_template_directory_uri() . '/bex/css/locomotive-scroll.min.css' );	
...
function my_register_scripts() {
    // wp_enqueue_script( 'jquery', get_template_directory_uri() . '/bex/js/jquery-3.5.1.slim.min.js' );
    ...
    // wp_enqueue_script( 'wow', get_template_directory_uri() . '/bex/js/wow.min.js' );
    ...
    // wp_enqueue_script( 'slimscroll', 'https://cdnjs.cloudflare.com/ajax/libs/slim-scroll/1.3.3/slimscroll.js' );
	
	// if( is_page_template( 'page-about-us.php' )) {
	// 	// wp_enqueue_script( 'concat', get_template_directory_uri() . '/bex/js/jquery.mCustomScrollbar.concat.min.js' );
	// }
	// if( is_front_page() ) {
	...
	wp_enqueue_script( 'TimelineLite', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/latest/TimelineLite.min.js' );
