...
<div id="js-home-wrapper" class="page-home-wrapper">
	<div id="js-home-sections" class="home-sections">
        <!-- first -->
        <section class="home-section hs1">
            <div class="hs-sub-wrapper d-flex align-items-center" id="pinContainer">
        		<section class="hs-sub p1 panel home-banner bg-trans" id="p1">
        			<!-- web view -->
                ...
                <section class="hs-sub p2 home-banner bg-trans" id="banner_title" >
        		...
        		<section class="hs-sub p3 section-leading-pharmacy  bg-trans" id="section_leading_pharmacy">
